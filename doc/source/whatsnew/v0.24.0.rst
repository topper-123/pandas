...
- Improved performance of :meth:`CategoricalIndex.astype` when converting to a non-categorical dtype (:issue:`xxxxx`)
- Improved performance of conversion of :class:`CategoricalIndex` instances to Numpy arrays with a different dtype than Categorical.categories (:issue:`xxxxx`)
